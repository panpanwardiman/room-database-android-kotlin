package com.example.crudwithroomdatabase.fragments.update
...
import com.example.crudwithroomdatabase.R
import com.example.crudwithroomdatabase.model.User
import com.example.crudwithroomdatabase.viewmodel.UserViewModel
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.update_age_et.setText(args.currentUser.age.toString()) // convert to string because age is integer
